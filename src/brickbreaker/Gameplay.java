...
public class Gameplay extends JPanel implements KeyListener, ActionListener{
    ...
    public void paint(Graphics g){
        ...
        if(ballposY >= 570){
            ...
            g.setColor(Color.yellow);
            g.setFont(new Font("serif", Font.BOLD, 25));
            g.drawString("Game Over and your score = "+score, 200, 300);
            g.setFont(new Font("serif", Font.BOLD, 20));
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(play){
           ...
           ballposX += ballXdir;
           ballposY += ballYdir;
           if(ballposX < 0){           // Ball refletion at left border
               ballXdir = -ballXdir;
           }
           if(ballposY < 0){           // Ball refletion at top border
               ballYdir = -ballYdir;
           }
           if(ballposX > 670){         // Ball refletion at right border
               ballXdir = -ballXdir;
           }
        }
        repaint();
